...
## Fork Changes (nagasakarenta/claude-code-action@beta)
...
- **Updated Base Action**: Uses `nagasakarenta/claude-code-base-action@beta` which includes OAuth credential handling
